...
void loop()
{
    ...
    display.println("Calibrating SCD30 CO2 Sensor...");
    display.setTextSize(1);
    display.println("Place sensor outside for at least 1 hour !");
    display.println("Sensor für mindestens eine Stunde an der frischen Luft lassen!");
    display.display();
